...
*& Report YR1006
*&---------------------------------------------------------------------*
*& Relatório ALV apenas com a tabela dos alunos utilizando uma tabela de saída criada aqui mesmo, ou seja, sem estrutura de tabela externa.
*&---------------------------------------------------------------------*
REPORT yr1014.
...
TABLES: ytem0003. "Tabela de Material


*Estrutura de Tabela de saída
TYPES: BEGIN OF ytsaida,
    YMATR LIKE ytem0003-YMATR,
    YNOME LIKE ytem0003-YNOME,
    YEERG LIKE ytem0003-YEERG,
    YNOMEC LIKE ytem0003-YNOMEC,
    YCSER LIKE ytem0003-YCSER,
    YCTUR LIKE ytem0003-YCTUR,
    YVALOR LIKE ytem0003-YVALOR,
    WAERS LIKE ytem0003-WAERS,
  END OF ytsaida.

*2-Tabelas Interna
DATA: t_ytem0003 TYPE TABLE OF ytem0003 WITH HEADER LINE,
      t_saida TYPE TABLE OF ytsaida WITH HEADER LINE,
...
CALL FUNCTION 'REUSE_ALV_FIELDCATALOG_MERGE'
 EXPORTING
   ...
   i_structure_name             = 'YST0003' "Aparentemente devemos utilizar uma estrutura de tabela no fieldcat."
