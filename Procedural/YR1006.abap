...
*2-Tabelas Interna
DATA: t_yt0005 TYPE TABLE OF yt0005,
      t_yt0001 TYPE TABLE OF yt0001,
      t_saida  TYPE TABLE OF yst0001,
...
FORM  f_monta_tabela_saida .
  ...
  LOOP AT t_yt0005 INTO w_yt0005.
    CLEAR w_saida.
    w_saida-mater = w_yt0005-mater.
    w_saida-denom = w_yt0005-denom.
    w_saida-brgew = w_yt0005-brgew.
    w_saida-ntgew = w_yt0005-ntgew.
    w_saida-gewei = w_yt0005-gewei.
    w_saida-status = w_yt0005-status.
    w_saida-tpmat = w_yt0005-tpmat.

   READ TABLE t_yt0001 INTO w_yt0001 WITH KEY tpmat = w_yt0005-tpmat.
   IF sy-subrc IS INITIAL.
     w_saida-denom_tp = w_yt0001-denom.
   ENDIF.
