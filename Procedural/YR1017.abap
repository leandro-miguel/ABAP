...
*& Report YR1006
*&---------------------------------------------------------------------*
*& Relatório ALV apenas com a tabela dos alunos e professores.
*&---------------------------------------------------------------------*
REPORT yr1017.
...
TABLES: ytem0003. "Tabela de Alunos

*2-Tabelas Interna
DATA: t_ytem0003 TYPE TABLE OF ytem0003 WITH HEADER LINE,
      t_ytem0004 TYPE TABLE OF ytem0004 WITH HEADER LINE,
      t_saida TYPE TABLE OF yst0004 WITH HEADER LINE,
...
SELECT-OPTIONS: s_ynome FOR ytem0003-ynome.
...
FORM f_seleciona_dados .
  SELECT * FROM ytem0003 INTO TABLE t_ytem0003
    WHERE ynome IN s_ynome.
   IF sy-subrc IS INITIAL.
      SELECT * FROM ytem0004 INTO TABLE t_ytem0004.
    ELSE.
...
FORM  f_monta_tabela_saida .
  LOOP AT t_ytem0003.
    CLEAR t_saida.
    t_saida-ymatr = t_ytem0003-ymatr.
    t_saida-ynome = t_ytem0003-ynome.
    t_saida-yeerg = t_ytem0003-yeerg.
    t_saida-ynomec = t_ytem0003-ynomec.
    t_saida-ycser = t_ytem0003-ycser.
    t_saida-yctur = t_ytem0003-yctur.
    t_saida-yvalor = t_ytem0003-yvalor.
    t_saida-waers = t_ytem0003-waers.
    READ TABLE t_ytem0004 INTO t_ytem0004 WITH KEY ynomec = t_ytem0003-ynomec.
    IF sy-subrc IS INITIAL.
      t_saida-nomep = t_ytem0004-nomep.
    ENDIF.
    APPEND t_saida.
   ENDLOOP.
ENDFORM.
...
CLEAR w_header.
  REFRESH t_header.
  w_header-typ = 'H'.
  w_header-info = TEXT-007. "Relatorio de Alunos
